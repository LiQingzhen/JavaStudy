...
public class CustomStringJavaCompiler {
    ...
    public boolean compiler() {
        ...
        // 如果此处报空指针异常，说明eclipse使用的是jre（运行环境），而我们要编译java代码，仅仅是运行环境不够，所以最好是改成jdk，或者将jdk下的tools.jar复制到jre/lib目录下
        StandardJavaFileManager standardFileManager = compiler.getStandardFileManager(diagnosticsCollector, Locale.CHINA, Charset.defaultCharset());
