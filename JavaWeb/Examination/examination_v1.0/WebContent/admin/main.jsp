            ...
            <div class="layui-side-scroll">
                ...
                <ul class="layui-nav layui-nav-tree" lay-filter="side-main">
                	<li class="layui-nav-item  layui-nav-itemed" id="custom">
                        <a href="javascript:;"><i class="layui-icon">&#xe620;</i>考生管理</a>
                        <dl class="layui-nav-child">
                            <dd id="chancesmanager"><a href="javascript:;" href-url="admin/stuAdd.jsp"><i class="layui-icon">&#xe621;</i>新增考生</a></dd>
                            <dd id="dischances"><a href="javascript:;" href-url="admin/stuInfo.jsp"><i class="layui-icon">&#xe621;</i>考生信息</a></dd>          
                        </dl>
                    </li>
                    <li class="layui-nav-item  layui-nav-itemed" id="custom">
                        <a href="javascript:;"><i class="layui-icon">&#xe620;</i>考试管理</a>
                        <dl class="layui-nav-child">
                            <dd id="chancesmanager"><a href="javascript:;" href-url="admin/examAdd.jsp"><i class="layui-icon">&#xe621;</i>添加考试</a></dd>
                            <dd id="dischances"><a href="javascript:;" href-url="admin/examInfo.jsp"><i class="layui-icon">&#xe621;</i>考试信息</a></dd>          
                        </dl>
                    </li>
                    <li class="layui-nav-item" id="orders">
                        <a href="javascript:;"><i class="layui-icon">&#xe620;</i>试卷管理</a>
                        <dl class="layui-nav-child">
                            <dd><a href="javascript:;" href-url="admin/autoPaper.jsp"><i class="layui-icon">&#xe621;</i>自动组卷</a></dd>
                            <dd><a href="javascript:;" href-url="admin/paperInfo.jsp"><i class="layui-icon">&#xe621;</i>试卷信息</a></dd>
                        </dl>
                    </li>
                    <li class="layui-nav-item  layui-nav-itemed" id="custom">
                        <a href="javascript:;"><i class="layui-icon">&#xe620;</i>题库管理</a>
                        <dl class="layui-nav-child">
                            <dd id="dischances"><a href="javascript:;" href-url="admin/questionImport.jsp"><i class="layui-icon">&#xe621;</i>批量导入</a></dd>
                            <dd id="dischances"><a href="javascript:;" href-url="admin/questionInfo.jsp"><i class="layui-icon">&#xe621;</i>题目信息</a></dd>            
                        </dl>
                    </li>
